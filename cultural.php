	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-8" align="middle" >
				...
				<div class="menu">
					<button  class="ui teal  button animated slideInLeft" data-rel="#content-a" style="width:200px;">Solo Dance</button><br><br>
					<button  class="ui teal  button animated slideInUp" data-rel="#content-b" style="width:200px;">Solo Singing </button><br><br>
					<button  class="ui teal  button animated slideInRight" data-rel="#content-c" style="width:200px;">Group Dance</button><br><br>
					<button  class="ui teal  button animated slideInDown" data-rel="#content-d" style="width:200px;">Fashion Show</button><br><br>
					<button  class="ui teal  button animated slideInDown" data-rel="#content-e" style="width:200px;">Face Off</button><br><br>
					<button  class="ui teal  button animated slideInDown" data-rel="#content-f" style="width:200px;">Nukkad Natak</button><br><br>
					<button  class="ui teal  button animated slideInDown" data-rel="#content-g" style="width:200px;">Ad Mad Show</button><br><br>
		...
		<div class="tab  containers"   id="content-a" >
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:40px;font-weight:lighter;" ><div class="animated zoomInRight">Solo Dance</div></span><br><br>	
		...
		<div class="tab containers" id="content-b" >
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:40px;font-weight:lighter;" ><div class="animated zoomInRight">Solo Singing</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
		...
		<div class="tab containers"  id="content-c" >
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:40px;font-weight:lighter;" ><div class="animated zoomInRight">Group Dance </div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
		...
		<div class="tab  containers"   id="content-d">
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:40px;height:800px;font-weight:lighter;" ><div class="animated zoomInRight">Fashion Show</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
		...
		<div class="tab  containers"  id="content-e">
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:50px;height:800px;font-weight:lighter;" ><div class="animated zoomInRight">Face Off</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
...
<div class="tab  containers"  id="content-f">
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:50px;height:800px;font-weight:lighter;" ><div class="animated zoomInRight">Nukkad Natak</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
		...
		<div class="tab  containers"  id="content-g">
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:50px;height:800px;font-weight:lighter;" ><div class="animated zoomInRight">Ad Mad Show</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
