	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-8" align="middle" >
				...
				<div class="menu">
					<button  class="ui teal  button animated slideInLeft" data-rel="#content-a" style="width:200px;">Dalal Street</button><br><br>
					<button  class="ui teal  button animated slideInUp" data-rel="#content-b" style="width:200px;">Rangoli</button><br><br>
					<button  class="ui teal  button animated slideInRight" data-rel="#content-c" style="width:200px;">Tug of War</button><br><br>
					<button  class="ui teal  button animated slideInDown" data-rel="#content-d" style="width:200px;">Mock CID</button><br><br>
					<button  class="ui teal  button animated slideInDown" data-rel="#content-e" style="width:200px;">Sketching</button><br><br>
					<button  class="ui teal  button animated slideInDown" data-rel="#content-f" style="width:200px;">Antakshri</button><br><br>
					<button  class="ui teal  button animated slideInDown" data-rel="#content-g" style="width:200px;">Roadies</button><br><br>
					<button  class="ui teal  button animated slideInDown" data-rel="#content-h" style="width:200px;">Newspaper Dance</button><br><br>
		...
		<div class="tab  containers"   id="content-a" >
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:40px;font-weight:lighter;" ><div class="animated zoomInRight">Dalal Street</div></span><br><br>	
		...
		<div class="tab containers" id="content-b" >
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:40px;font-weight:lighter;" ><div class="animated zoomInRight">Rangoli</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
		...
		<div class="tab containers"  id="content-c" >
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:40px;font-weight:lighter;" ><div class="animated zoomInRight">Tug of War</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
		...
		<div class="tab  containers"   id="content-d">
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:40px;height:800px;font-weight:lighter;" ><div class="animated zoomInRight">Mock CID</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
		...
		<div class="tab  containers"  id="content-e">
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:50px;height:800px;font-weight:lighter;" ><div class="animated zoomInRight">Sketching</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
...
<div class="tab  containers"  id="content-f">
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:50px;height:800px;font-weight:lighter;" ><div class="animated zoomInRight">Antakshri</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
		...
		<div class="tab  containers"  id="content-g">
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:50px;height:800px;font-weight:lighter;" ><div class="animated zoomInRight">Roadies</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
		...
		<div class="tab  containers"  id="content-h">
			<div class=col-md-8 style="background-color:teal;height:800px;font-family: 'Rajdhani', sans-serif;">
				...
				<div class="ui left aligned basic segment">
					<span style="color:white; font-size:50px;height:800px;font-weight:lighter;" ><div class="animated zoomInRight">Newspaper Dance</div></span><br><br>	
					<div class="ui horizontal divider">
						..
					</div>
					<div class=" ui teal  button " align="left">
